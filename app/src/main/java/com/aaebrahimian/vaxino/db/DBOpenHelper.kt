...
class DBOpenHelper(context : Context?) : SQLiteOpenHelper( context , null ,null , 1 ) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        val createPersonTable = "CREATE TABLE $NAME_TABLE_PERSON ($COLUMN_SSN INTEGER,$COLUMN_FIRST_NAME TEXT,$COLUMN_LAST_NAME TEXT,$COLUMN_AGE DATE,$COLUMN_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, $COLUMN_GENDER BIT$COLUMN_PHONE_NUMBER NUMBER)"
