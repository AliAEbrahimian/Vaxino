...
class DBOpenHelper(context : Context?) : SQLiteOpenHelper( context , null ,null , 1 ) {
    ...
    fun data(db: SQLiteDatabase?) {
        insertClinicTable(db, 32330043, R.drawable.images,"Mehregan Hospital","Sheykh Bahaie",1,1)
        insertClinicTable(db, 32330043, R.drawable.images,"Mehregan Hospital","Sheykh Bahaie",1,2)
        insertClinicTable(db, 32222127, R.drawable.images,"Khorshid Hospital","Ostandari",1,1)
        insertClinicTable(db, 32222127, R.drawable.images,"Khorshid Hospital","Ostandari",1,2)
        insertClinicTable(db, 34509901, R.drawable.images,"Gharazi Hospital","Kave",1,1)
        insertClinicTable(db, 34509901, R.drawable.images,"Gharazi Hospital","Kave",1,2)
        insertClinicTable(db, 37774001, R.drawable.images,"Milad Hospital","Three Way Simin",1,1)
        insertClinicTable(db, 37774001, R.drawable.images,"Milad Hospital","Three Way Simin",1,2)
        insertClinicTable(db, 32346338, R.drawable.images,"Shahid Beheshti Hospital","Bridge Felezi",1,1)
        insertClinicTable(db, 32346338, R.drawable.images,"Shahid Beheshti Hospital","Bridge Felezi",1,2)
        insertClinicTable(db, 32250041, R.drawable.images,"Askarie Hospital","Soroush",1,1)
        insertClinicTable(db, 32250041, R.drawable.images,"Askarie Hospital","Soroush",1,2)
        insertClinicTable(db, 36272001, R.drawable.images,"Shariati Hospital","Chahar Bagh Bala",1,2)
        insertClinicTable(db, 32600961, R.drawable.images,"Chamran Hospital","Bridge bozorgmeh",1,2)
        insertClinicTable(db, 36273031, R.drawable.images,"Saadi Hospital","Nazar",1,2)
        insertClinicTable(db, 84090, R.drawable.images,"Milad Hospital","Highway Hemat",2,1)
        insertClinicTable(db, 84090, R.drawable.images,"Milad Hospital","Highway Hemat",2,2)
        insertClinicTable(db, 88820091, R.drawable.images,"Jam Hospital","Shahid Motahari",2,1)
        insertClinicTable(db, 88820091, R.drawable.images,"Jam Hospital","Shahid Motahari",2,2)
        insertClinicTable(db, 88787111, R.drawable.images,"Dey Hospital","Vali Asr",2,1)
        insertClinicTable(db, 88787111, R.drawable.images,"Dey Hospital","Vali Asr",2,2)
        insertClinicTable(db, 38241, R.drawable.images,"Fajr Hospital","Piruzi",2,1)
        insertClinicTable(db, 38241, R.drawable.images,"Fajr Hospital","Piruzi",2,2)
        insertClinicTable(db, 55630213, R.drawable.images,"Razi Hospital","Vahdat",2,2)
        insertClinicTable(db, 88751477, R.drawable.images,"Madaran Hospital","Takhti Square, Khalil Hoseni",2,2)
        insertClinicTable(db, 63120, R.drawable.images,"Sina Hospital","Emam Khomeini",2,1)
        insertClinicTable(db, 22824011, R.drawable.images,"Norafshar Hospital","Niavaan",2,2)
        insertClinicTable(db, 23021000, R.drawable.images,"Erfan Hospital","Saadat abad",2,2)
